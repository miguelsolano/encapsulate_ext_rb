...
srcdir = .
topdir = /Users/miguelsolano/.rvm/rubies/ruby-2.6.5/include/ruby-2.6.0
hdrdir = $(topdir)
arch_hdrdir = /Users/miguelsolano/.rvm/rubies/ruby-2.6.5/include/ruby-2.6.0/x86_64-darwin19
PATH_SEPARATOR = :
VPATH = $(srcdir):$(arch_hdrdir)/ruby:$(hdrdir)/ruby
prefix = $(DESTDIR)/Users/miguelsolano/.rvm/rubies/ruby-2.6.5
...
DEFS     = 
CPPFLAGS =   -std=c++14 -I/usr/local/opt/libyaml/include -I/usr/local/opt/libksba/include -I/usr/local/opt/readline/include -I/usr/local/opt/zlib/include -I/usr/local/opt/openssl@1.1/include -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT $(DEFS) $(cppflags)
...
ORIG_SRCS = encapsulate.c
SRCS = $(ORIG_SRCS) 
OBJS = encapsulate.o
HDRS = 
LOCAL_HDRS = 
TARGET = encapsulate
TARGET_NAME = encapsulate
